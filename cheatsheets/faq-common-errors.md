...
### Boot (after successful build/activation)
...
- [Nix manual — `nix.conf`](https://nix.dev/manual/nix/stable/command-ref/conf-file.html) — `show-trace`, trust/substituter settings
