...
Suggested reading orders by audience. Each path links into the numbered domains; pick one that matches what you are trying to do, not how much you already know.

See [Nix Docs](../README.md) for the full domain list, and [conventions](../meta/conventions.md) for how this wiki grows.

## How to choose

- **Beginner** — New to Nix or NixOS; want a first pass through philosophy, concepts, and a working system.
