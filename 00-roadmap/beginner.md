...
6. Optional: [Config repo layout](../07-flakes/workflows/config-repo-layout.md) — `hosts/` / `modules/` / `users/` mono-repo shape
7. Optional skim: [import from derivation](../02-concepts/import-from-derivation.md) — why flake checks sometimes trigger builds during eval
